...
import { User, Mail, Lock, Phone, MapPin, Building, Globe, ArrowRight, Sparkles, Check, Eye, EyeOff } from "lucide-react";
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-green-50 via-white to-emerald-50 p-4">
      <div className="w-full max-w-2xl">
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground mt-2">Join thousands of learners advancing their careers</p>
        </div>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div className="space-y-2">
                  ...
                  />
                  {errors.middle_name && (
                    <p className="text-sm text-red-500">{errors.middle_name.message}</p>
                  )}
                </div>
                ...
                {password && (
                  <div className="mt-2 space-y-1">
                    ...
                    <div className="flex flex-wrap gap-2">
                      ...
                      <div className={`flex items-center gap-1 text-xs ${hasLetter ? 'text-green-600' : 'text-gray-400'}`}>
                        <Check className="w-3 h-3" />
                        Letter
                      </div>
                      ...
                      <div className={`flex items-center gap-1 text-xs ${hasSpecial ? 'text-green-600' : 'text-gray-400'}`}>
                        <Check className="w-3 h-3" />
                        Special char
                      </div>
                    </div>
